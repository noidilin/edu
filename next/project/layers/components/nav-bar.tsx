...
export default function Navbar() {
  ...
  return (
    <section className='fixed top-0 z-50 w-full py-4 lg:py-8'>
      <div className='mx-auto max-w-10/12 rounded-xl border border-foreground/15 bg-card backdrop-blur'>
        <div className='grid flex-1 grid-cols-2 items-center px-6 py-2 lg:grid-cols-3'>
          <div>
            <Image
              alt='layers logo'
              className='h-9 w-auto hue-rotate-330 invert-75 saturate-10 lg:h-auto dark:invert-0'
              src={logoImage}
            />
          </div>
